var capacitorStripe = (function (exports, core, terminalJs) {
    'use strict';
    ...
    class StripeTerminalWeb extends core.WebPlugin {
        ...
        async initialize(options) {
            ...
            this.stripeTerminal = stripeTerminal === null || stripeTerminal === undefined ? undefined : stripeTerminal.create({
        ...
        async connectReader(options) {
            ...
            const connectedResult = await ((_a = this.stripeTerminal) === null || _a === undefined ? undefined : _a.connectReader(reader));
        ...
        async getConnectedReader() {
            var _a;
            const reader = (_a = this.stripeTerminal) === null || _a === undefined ? undefined : _a.getConnectedReader();
            if (reader === undefined) {
                return {
                    reader: null,
                };
        ...
        async disconnectReader() {
            var _a;
            await ((_a = this.stripeTerminal) === null || _a === undefined ? undefined : _a.disconnectReader());
            this.notifyListeners(exports.TerminalEventsEnum.DisconnectedReader, null);
        }
        async collectPaymentMethod(options) {
            var _a;
            const collectResult = await ((_a = this.stripeTerminal) === null || _a === undefined ? undefined : _a.collectPaymentMethod(options.paymentIntent));
        ...
        async cancelCollectPaymentMethod() {
            var _a;
            await ((_a = this.stripeTerminal) === null || _a === undefined ? undefined : _a.cancelCollectPaymentMethod());
        ...
        async confirmPaymentIntent() {
            ...
            const processResult = await ((_a = this.stripeTerminal) === null || _a === undefined ? undefined : _a.processPayment(this.cachedPaymentIntent));
        ...
        async setReaderDisplay(options) {
            var _a;
            await ((_a = this.stripeTerminal) === null || _a === undefined ? undefined : _a.setReaderDisplay({
                type: 'cart',
        ...
        async clearReaderDisplay() {
            var _a;
            await ((_a = this.stripeTerminal) === null || _a === undefined ? undefined : _a.clearReaderDisplay());
        }
        async rebootReader() {
