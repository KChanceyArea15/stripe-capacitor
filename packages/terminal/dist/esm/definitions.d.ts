...
import type { TerminalConnectTypes, UpdateTimeEstimate, SimulateReaderUpdate, SimulatedCardType, BatteryStatus, ReaderEvent, ReaderDisplayMessage, ReaderInputOption, PaymentStatus, DisconnectReason, ConnectionStatus, NetworkStatus, LocationStatus, DeviceType } from './stripe.enum';
...
export declare type LocationInterface = {
    id: string;
    displayName: string;
    address: {
        city: string;
...
export declare type ReaderSoftwareUpdateInterface = {
...
export interface StripeTerminalPlugin {
     ...
     */
    addListener(eventName: TerminalEventsEnum.DisconnectedReader, listenerFunc: ({ reason }: {
     ...
     */
    addListener(eventName: TerminalEventsEnum.ConnectionStatusChange, listenerFunc: ({ status }: {
     ...
     */
    addListener(eventName: TerminalEventsEnum.UnexpectedReaderDisconnect, listenerFunc: ({ reader }: {
        reader: ReaderInterface;
    }) => void): Promise<PluginListenerHandle>;
     ...
     */
    addListener(eventName: TerminalEventsEnum.Failed, listenerFunc: (info: {
        message: string;
        code?: string;
        declineCode?: string;
    }) => void): Promise<PluginListenerHandle>;
     ...
     */
    addListener(eventName: TerminalEventsEnum.ReaderSoftwareUpdateProgress, listenerFunc: ({ progress }: {
        progress: number;
    }) => void): Promise<PluginListenerHandle>;
    /**
     * **Only applicable to Bluetooth and USB readers.**
     ...
     */
    addListener(eventName: TerminalEventsEnum.FinishInstallingUpdate, listenerFunc: (args: {
        update: ReaderSoftwareUpdateInterface;
    } | {
        error: string;
    }) => void): Promise<PluginListenerHandle>;
     ...
     */
    addListener(eventName: TerminalEventsEnum.ReaderEvent, listenerFunc: ({ event }: {
        event: ReaderEvent;
    }) => void): Promise<PluginListenerHandle>;
    /**
     * **Only applicable to Bluetooth and USB readers.**
     ...
     */
    addListener(eventName: TerminalEventsEnum.PaymentStatusChange, listenerFunc: ({ status }: {
    ...
    addListener(eventName: TerminalEventsEnum.ReaderReconnectSucceeded, listenerFunc: ({ reader }: {
        reader: ReaderInterface;
    }) => void): Promise<PluginListenerHandle>;
    addListener(eventName: TerminalEventsEnum.ReaderReconnectFailed, listenerFunc: ({ reader }: {
        reader: ReaderInterface;
    }) => void): Promise<PluginListenerHandle>;
    addListener(eventName: TerminalEventsEnum.ProcessedPayment, listenerFunc: ({ id }: {
        id: string;
    }) => void): Promise<PluginListenerHandle>;
}
